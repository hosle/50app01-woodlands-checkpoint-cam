...
enum TabType { woodlands, tuas }

class CheckpointTabView extends StatefulWidget {
  const CheckpointTabView({
    super.key,
...
class _CheckpointTabViewState extends State<CheckpointTabView>
  ...
  String get _tabTitle {
    switch (widget.tabType) {
      case TabType.woodlands:
        return 'Woodlands Checkpoint';
      case TabType.tuas:
        return 'Tuas Checkpoint';
    }
  }

  CheckpointType get _checkpointType {
    switch (widget.tabType) {
      case TabType.woodlands:
        return CheckpointType.woodlands;
      case TabType.tuas:
        return CheckpointType.tuas;
    }
  }
  ...
  void initState() {
    super.initState();
    _viewModel = WoodlandsCheckpointsViewModel(checkpointType: _checkpointType);
